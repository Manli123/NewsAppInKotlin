...
import com.example.newsapp.databinding.FragmentHaedlinesBinding
...
class HaedlinesFragment : Fragment(R.layout.fragment_haedlines) {
    ...
    lateinit var binding:FragmentHaedlinesBinding
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding=FragmentHaedlinesBinding.bind(view)
        ...
        newsAdapter.setOnItemClickListener {
            ...
            findNavController().navigate(R.id.action_haedlinesFragment_to_articleFragment,bundle)
        }
    ...
    private fun setUpHeadlineRecyclerView(){
        ...
        binding.recyclerHeadlines.apply {
            ...
            addOnScrollListener(this@HaedlinesFragment.scrollListener)
        }
    }
